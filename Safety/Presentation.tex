...
\vspace{-.5cm}
\begin{figure}
   \includegraphics[width=1\textwidth]{Codes/BasicsSafety/ProbabilisticModel.eps}%
   \end{figure}
\end{columns}
...
\visible<13->{\textbf{Remarks}: the ``oracle" can be very hard to build, or not...}
\begin{columns}[t]
\column{0.3\textwidth}
\visible<13->{
\includegraphics[width=1\textwidth,clip]{Figures/Chess.eps}
...
\center
Able to stop in the visible distance}
\column{0.3\textwidth}
...
\begin{frame}{\normalsize Control Barrier Functions}
\footnotesize
