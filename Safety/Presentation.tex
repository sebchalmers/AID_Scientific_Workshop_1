...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{itemize}
    \visible<1->{
      \item Re-plan at each step with safety in mind, hedging against worst case uncertainties in the future.
    }
        \visible<2->{
...
\begin{overlayarea}{0.4\textwidth}{0.7\textheight}
  ...
  \only<2>{
        \begin{figure}
        \centering
        \includegraphics[width=1.5\textwidth]{Codes/RobustMPC/IllustrationRobustMPCPreTerminal.eps}
      \end{figure}
}
\only<3>{
        \begin{figure}
        \centering
        \includegraphics[width=1.5\textwidth]{Codes/RobustMPC/IllustrationRobustMPCTerminal.eps}
      \end{figure}
}
\only<4>{
