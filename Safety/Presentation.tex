...
\begin{itemize}
\item from data: it may expand with more data, safety is ``asymptotic", as data $\rightarrow\infty$
\item \visible<14->{from knowledge: can be impractically pessimistic}
\end{itemize}
}
\end{overlayarea}
