...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{itemize}
    ...
    \uncover<6->{\item {Knowledge embedding:} encode physics/rules as priors or constraints on models.}
    \uncover<7->{\item \textbf{Bayesian view:} posterior $p(P\mid\mathcal D)$ over kernels}
    \uncover<8->{\item \textbf{Building $\mathcal P$:}  ensembles, parametric, non-parametric.}
  \end{itemize}
...
\begin{itemize}
  ...
  \item Probabilistic safety with confidence levels (chance constraints)  
