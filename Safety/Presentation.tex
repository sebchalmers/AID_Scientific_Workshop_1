...
% Low density
 ...
 \includegraphics[width=1\textwidth,clip]{Codes/Epistemic/Dist_s_a_0.pdf}
  ...
  \visible<6->{
    ...
    \begin{itemize}
    \scriptsize
    \item Low data $\rightarrow$ uncertainty about the distributions \textit{themselves}
    \item  \visible<7->{State-action not much explored $\rightarrow$ epistemic uncertainty}
    \item  \visible<8->{Continuous state-action problems $\rightarrow$ single data point per $\vect s,\vect a$. Rely on regularity!}
    \end{itemize}
 };}
