...
\visible<2->{
% High density
\node[  below right = 16mm and 9mm of SA0.north west] (SA1) {\textcolor{red}{$\vect s,\vect a$}};  
}
...
\visible<5->{
% Low density
\node[  below right =  22mm and 32mm of SA0.north west] (SA3) {\textcolor{red}{$\vect s,\vect a$}};   
}
