...
\tikzstyle{SA_block} = [rectangle, draw=none, fill=none,  text width=4cm,  text height=3cm,  text centered]
\tikzstyle{line} = [draw, -latex']
...
\textbf{State \& actions}
 ...
 \node[  below right = 18mm and 4mm of SA0.north west] (SA1) {\textcolor{red}{$\vect s,\vect a$}};
 \node[  below right =  -3mm and 20mm of SA0.north west] (SA2) {\textcolor{red}{$\vect s,\vect a$}};
  \node[  below right =  26mm and 30mm of SA0.north west] (SA3) {\textcolor{red}{$\vect s,\vect a$}};
