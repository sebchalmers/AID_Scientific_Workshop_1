...
\vspace{-.25cm}
\begin{align*}
\textcolor{myMagenta}{\vect\pi^\text{OOD}} = \argmax_{\vect\pi}\,\mathrm E\left[ \sum_{k=0}^\infty \gamma^k\left(\vect s_k^2+\vect a_k^2-\varphi\left(\vect s_k,\vect a_k\right)\right)\right]
\end{align*}
\end{alertblock}
\flushright where $\varphi$ is the data distribution (e.g. kernel)
