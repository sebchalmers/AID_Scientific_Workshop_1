...
for case in Pi:
    ...
    for k in range(0,N):
        ...
        ax1.text(.5,Policy(.5,Pi['Star']),r'$\bf\pi^\star(s)$',fontsize=30,verticalalignment='bottom',horizontalalignment='left')
        ...
        figID.savefig('OOD_'+case+'_.jpeg', transparent=None, dpi='figure', format=None,metadata=None, bbox_inches='tight', pad_inches=0.1,facecolor='auto', edgecolor='auto', backend=None) #, bbox_inches='tight'
